...
const ProfileSection: React.FC = () => {
  ...
  const [currentName, setCurrentName] = useState(fullname ?? "Usuario Nuevo");
  const [isHovered, setIsHovered] = useState(false);
  const [profileImg, setProfileImg] = useState(initialImg ?? "https://garyzobzlptusalyktgr.supabase.co/storage/v1/object/public/images/predetprofil.jpeg?t=2024-11-05T21%3A00%3A13.093Z");
  ...
  useEffect(() => {
    setProfileImg(initialImg ?? "https://garyzobzlptusalyktgr.supabase.co/storage/v1/object/public/images/predetprofil.jpeg?t=2024-11-05T21%3A00%3A13.093Z");
  }, [initialImg]);
          ...
          <div className="bg-custom-color-2 text-black h-full w-full overflow-hidden overflow-y-auto">
            <div className="mb-2 ml-14">
              <div className="flex justify-between items-center mb-5">
                <h1 className="text-black text-4xl font-bold">Perfil</h1>
              </div>
              <div style={{ display: 'grid', placeItems: 'center', height: '10vh' }}>
                ...
                <div className="flex justify-between items-center gap-2">
                  <h3 className="text-black text-3xl">{currentName}</h3>
